        ...
        **flags: Any,
        ...
        Args:
            ...
            Q: Queries for the algorithms supported by one of the following
                ...
                (supported symmetric ciphers that support authenticated en‐
                cryption), help (supported query terms for use with the -Q flag),
                ...
                versions), and sig (supported signature algorithms). May be
                repeated: a list emits the flag once per item. Added in 6.3p1.
