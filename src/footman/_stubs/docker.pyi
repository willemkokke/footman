...
#
# Read from docker 29.6.2 on Linux, Windows and macOS. In-process: no.
    ...
    def run(
        ...
        **flags: Any,
        ...
        Args:
            ...
            cpu_count: CPU count (Windows only). Not available on macOS.
            cpu_percent: CPU percent (Windows only). Not available on macOS.
            ...
            io_maxbandwidth: Maximum IO bandwidth limit for the system drive
                (Windows only). Not available on macOS.
