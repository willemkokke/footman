        ...
        **flags: Any,
        ...
        Args:
            ...
            attest: Attestation parameters (format: "type=sbom,generator=image").
                May be repeated: a list emits the flag once per item. Not available
                on Windows.
            ...
            call: Set method for evaluating build ("check", "outline", "targets").
                Defaults to `build`. Not available on Windows.
            ...
            compress: Compress the build context using gzip. Added in 29.7.0. Not
                available on Linux and macOS.
            cpu_period: Limit the CPU CFS (Completely Fair Scheduler) period. Added
                in 29.7.0. Not available on Linux and macOS.
            cpu_quota: Limit the CPU CFS (Completely Fair Scheduler) quota. Added in
                29.7.0. Not available on Linux and macOS.
            cpu_shares: CPU shares (relative weight). Added in 29.7.0. Not available
                on Linux and macOS.
            ...
            force_rm: Always remove intermediate containers. Added in 29.7.0. Not
                available on Linux and macOS.
            ...
            memory_swap: Swap limit equal to memory plus swap: -1 to enable
                unlimited swap. Added in 29.7.0. Not available on Linux and macOS.
            metadata_file: Write build result metadata to a file. Not available on
                Windows.
            ...
            progress: Set type of progress output ("auto", "none", "plain", "quiet",
                "rawjson", "tty"). Defaults to `auto`. Not available on Windows.
            provenance: Shorthand for "--attest=type=provenance". Not available on
                Windows.
            pull: Always attempt to pull a newer version of the image.
            push: Shorthand for "--output=type=registry,unpack=false". Not available
                on Windows.
            ...
            resource: Resource limits for build containers (format: "memory=2g",
                "cpu-quota=50000"). May be repeated: a list emits the flag once per
                item. Added in 29.6.0. Not available on Windows.
            rm: Remove intermediate containers after a successful build. Defaults to
                `True`. Added in 29.7.0. Not available on Linux and macOS.
            ...
            secret: Secret to expose to the build (format:
                ...
                the flag once per item. Not available on Windows.
            security_opt: Security options. Added in 29.7.0. Not available on Linux
                and macOS.
    ...
    def run(
        ...
        **flags: Any,
        ...
        Args:
            ...
            io_maxiops: Maximum IOps limit for the system drive (Windows only). Not
                available on Linux.
